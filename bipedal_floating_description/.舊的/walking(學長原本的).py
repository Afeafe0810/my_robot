...
class UpperLevelController(Node):
    ...
    def __init__(self):
        ...
        #path_data_ALIP
        self.ACX_ref_data = pd.read_csv('/home/ldsc/matlab/ALIP/CX_ref.csv', header=None).values #相對於大地的
        ...
        self.ar_past_R = 0.0
        #--ref    
        self.xc_ref = pd.read_csv('/home/ldsc/matlab/ALIP/xc_ref.csv', header=None).values #這個是對cf的
